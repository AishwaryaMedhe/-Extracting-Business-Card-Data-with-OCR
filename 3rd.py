...
if st.session_state.authentication_status==True:
    ...
    if nav=='HOME':
        ...
        if isinstance(file,BytesIO):
            ...
            if sb1=='Export the Data to SQL' and st.button("Export"):
                ...
                engine = create_engine('mysql+mysqlconnector://root:Dreamer_1@localhost/bizcard')
                data1, data2 = data()
    ...
    #block of code to define the author data
        ...
        st.markdown("#### _Aishwarya Medhe_")
        st.markdown("### Linked In")
        st.info("https://www.linkedin.com/in/aishwarya-medhe-a328bb286")
